...
function BuscarPedimentos(){
    $("#mensaje").html("Procesando la petición....");
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                for(i = 0;i<val.length;i++) {
                    ...
                    if(doc[5] == 1)html+="<td><a href='Anexos/MANIFESTACION DE VALOR/"+val[i][0]+".pdf' target = '_blank'><img title='Manifiesto de Valor' src='img/excel.png' width ='16' height ='16'></a></td>";else html+="<td></td>";html+="</tr>";
                } 
                html+="</tbody>";
                $("#contenido").html(html);
            }
